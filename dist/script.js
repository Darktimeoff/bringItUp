...
/* harmony import */ var _modules_slider_slider_main_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/slider/slider-main.component */ "./src/js/modules/slider/slider-main.component.js");
/* harmony import */ var _modules_playVideo_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/playVideo.component */ "./src/js/modules/playVideo.component.js");
/* harmony import */ var _modules_slider_slider_mini_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/slider/slider-mini.component */ "./src/js/modules/slider/slider-mini.component.js");
/* harmony import */ var _modules_difference_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/difference.component */ "./src/js/modules/difference.component.js");
/* harmony import */ var _modules_form_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/form.component */ "./src/js/modules/form.component.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var mainPageSlider = new _modules_slider_slider_main_component__WEBPACK_IMPORTED_MODULE_0__["default"]({
    container: '.page',
    btns: '.next',
    logo: '.sidecontrol .logo'
  });
  mainPageSlider.render();
  var showUpSlider = new _modules_slider_slider_mini_component__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  showUpSlider.init();
  var modulesSlider = new _modules_slider_slider_mini_component__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  modulesSlider.init();
  var feedSlider = new _modules_slider_slider_mini_component__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  differenceNew.init();
  var differenceOld = new _modules_difference_component__WEBPACK_IMPORTED_MODULE_3__["default"]({
...
/***/ "./src/js/modules/difference.component.js":
/*!************************************************!*\
  !*** ./src/js/modules/difference.component.js ***!
  \************************************************/
...
function () {
  function Difference(_ref) {
    var container = _ref.container,
        ...
        animateClass = _ref.animateClass;
  ...
  _createClass(Difference, [{
    ...
    key: "moreComponent",
    value: function moreComponent(_ref2) {
      var containers = _ref2.containers,
          options = _objectWithoutProperties(_ref2, ["containers"]);
...
function () {
  function Form() {
    var forms = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  ...
  _createClass(Form, [{
    ...
    value: function init() {
      ...
      this.$forms.forEach(function (form) {
        form.addEventListener('submit', _formSubmitHandler.bind(_this));
      });
      console.log('hello1');
    }
  }, {
    key: "useSubmitLoading",
    value: function useSubmitLoading() {}
  }, {
    key: "useSubmitSuccess",
    value: function useSubmitSuccess() {}
  }, {
    key: "useSubmitUnSuccess",
    value: function useSubmitUnSuccess() {}
  }]);
...
function _formSubmitHandler(e) {
  ...
  _services_request_services__WEBPACK_IMPORTED_MODULE_7__["default"].postRequest(data, this.path).then(function (response) {
    console.log(response);
    statusMessage.textContent = _this2.message.success;

    _this2.useSubmitSuccess();
...
/***/ "./src/js/modules/playVideo.component.js":
/*!***********************************************!*\
  !*** ./src/js/modules/playVideo.component.js ***!
  \***********************************************/
/*! exports provided: default */
...
function _overlayStyle(display, addClass, removeClass) {
  var _this$$overlay$classL, _this$$overlay$classL2;
...
/***/ "./src/js/modules/slider/slider-main.component.js":
/*!********************************************************!*\
  !*** ./src/js/modules/slider/slider-main.component.js ***!
  \********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _slider_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./slider.component */ "./src/js/modules/slider/slider.component.js");
...
function (_Slider) {
  ...
  return MainSlider;
}(_slider_component__WEBPACK_IMPORTED_MODULE_10__["default"]);
  ...
  if (this.$container.classList.contains('page')) {
    ...
    if (this.slideIndex === 3) {
      setTimeout(function () {
        ...
        _this3.hanson.classList.add('animated', 'slideInUp');
      }, 3000);
    } else {
...
/***/ "./src/js/modules/slider/slider-mini.component.js":
/*!********************************************************!*\
  !*** ./src/js/modules/slider/slider-mini.component.js ***!
  \********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _slider_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./slider.component */ "./src/js/modules/slider/slider.component.js");
...
function (_Slider) {
  ...
  function MiniSlider(_ref) {
    ...
    var _ref$slides = _ref.slides,
        slides = _ref$slides === void 0 ? null : _ref$slides,
        options = _objectWithoutProperties(_ref, ["slides"]);
  ...
  return MiniSlider;
}(_slider_component__WEBPACK_IMPORTED_MODULE_12__["default"]);
...
function _hideActiveSlide() {
  ...
  var active = this.$slides.find(function (slide) {
    return slide.classList.contains(_this2.activeClass);
  });
...
/***/ "./src/js/modules/slider/slider.component.js":
/*!***************************************************!*\
  !*** ./src/js/modules/slider/slider.component.js ***!
  \***************************************************/
/*! exports provided: default */
...
var Slider = function Slider() {
  ...
  try {
    this.$container = document.querySelector(container);
    this.$slides = _toConsumableArray(this.$container.children);
...
function () {
  ...
  _createClass(RequestService, null, [{
    ...
    key: "postFormData",
    value: function postFormData(data, url) {
      var request;
      return regeneratorRuntime.async(function postFormData$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _context2.abrupt("return", _useRequestFormData(request));
    ...
    value: function getRequest(url) {
      var request;
      return regeneratorRuntime.async(function getRequest$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              request = new Request(url);
              return _context3.abrupt("return", _useRequest(request));
...
function _useRequest(request) {
  var response;
  return regeneratorRuntime.async(function _useRequest$(_context4) {
    while (1) {
...
function _useRequestFormData(request) {
  var response;
  return regeneratorRuntime.async(function _useRequestFormData$(_context5) {
    while (1) {
